...
### Мої враження від матеріалів даної секції:
Було цікаво дізнатись про таку імплементацію дропдауна/попап меню, без використання 
...
![FCC-tasks](task_js_dom/FCC-12-18.png)
...
**Free Code Camp tasks:**<br>
- Деякі з задач(Фібоначчі, сума усіх простих чисел) вдалось виконати лише після вивчення варіантів їх розв'язання у підказках.
- Цікавою була задача на рекурсію(зменшення розмірності масиву).
- Сподіваюсь, буде менше страху застосовувати рекурсію та інші, на перший погляд, складні підходи, де це буде обґрунтовано.

## 9. JS PRE-OOP
[Demo](https://d-pozniak.github.io/a-tiny-JS-world/)

## 10. JS OOP

### Мої враження від матеріалів даної секції:
**Відео про ООП класи та прототипи:**<br>
Переглядаючи відео, усе здавалось більш-менш зрозумілим, але під час роботи над Frogger довелось гуглити способи реалізації механізму наслідування.

**Frogger**<br>
[Demo](https://d-pozniak.github.io/frontend-nanodegree-arcade-game/)
Майже вперше в житті працювала з класами. Найскладнішим виявилось рефакторити код, щоб уникнути "магічних цифр".

**Codewars**<br>
Дійти до 7kyu було значно легше, ніж вирішувати задачі з останніх рівнів freeCodeCamp. Сподобалась ця платформа тим, що можна переглянути розв'язки інших учасників, корегуючи тим самим власні ідеї.